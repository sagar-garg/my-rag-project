...
- Collection: `book_chapters_4_6_c256o40` (local embedded Qdrant)
- Chunking: size 256, overlap 40
...
| Mean first-hit rank | 1.13 |
| Worst first-hit rank | 3 |
...
| 3 | What are the two dominant patterns for context construction described in Chapter 6? | Ch6 | ✅ hit | 3 | 2/4 | Ch5, Ch5, Ch6, Ch6 |
...
| 8 | Where in a long input should important information be placed so the model doesn't overlook it? | Ch5 | ✅ hit | 1 | 2/4 | Ch5, Ch6, Ch5, Ch6 |
...
| 13 | Follow-up questions like 'what about her?' return junk results — what technique addresses this? | Ch6 | ✅ hit | 1 | 3/4 | Ch6, Ch6, Ch6, Ch4 |
...
Small-chunk leg of the 2026-07-19 chunking sweep: purity unchanged (55/60),
ranks worse — Q3 fell to rank 3, the sweep's worst single result. Analysis in
the [sweep comparison](2026-07-19-chunking-comparison.md).
