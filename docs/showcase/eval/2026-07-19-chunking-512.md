# Chunking 512/80 (baseline) — 2026-07-19
...
Baseline leg of the 2026-07-19 chunking sweep — identical to the
[2026-07-18 expanded-set run](2026-07-18-expanded-set.md) (retrieval is
deterministic), re-run to produce the new Summary block. Analysis in the
[sweep comparison](2026-07-19-chunking-comparison.md).
