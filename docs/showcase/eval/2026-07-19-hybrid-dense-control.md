# Hybrid iteration — dense control — 2026-07-19
...
Control leg for the hybrid iteration. Reproduces the chunking-sweep 512/80
baseline exactly (purity 55/60, mean rank 1.07, worst 2; weak questions
Q3 2/4, Q8 rank 2 & 2/4, Q13 3/4) — retrieval is deterministic, so the
hybrid leg is measured against a verified baseline. Verdict in the
[comparison artifact](2026-07-19-hybrid-comparison.md).
