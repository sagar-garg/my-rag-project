# Hybrid iteration — dense + BM25 (RRF) — 2026-07-19
...
- Retrieval: hybrid (dense + BM25, RRF k=60, 12 candidates/side) top-4
...
|--------|-------|
| Hit@4 | 15/15 (100%) |
| Purity (on-target chunks) | 52/60 (87%) |
...
| 3 | What are the two dominant patterns for context construction described in Chapter 6? | Ch6 | ✅ hit | 1 | 3/4 | Ch6, Ch5, Ch6, Ch6 |
...
| 7 | How many examples do I need before I can trust that one system is really better than another? | Ch4 | ✅ hit | 1 | 3/4 | Ch4, Ch4, Ch4, Ch6 |
...
| 9 | The bot keeps answering children's questions in a way that ruins the magic — how do I fix its tone without retraining it? | Ch5 | ✅ hit | 1 | 3/4 | Ch5, Ch5, Ch4, Ch5 |
| 10 | Someone got our assistant to reveal its hidden configuration text — how does that attack work and why does it matter? | Ch5 | ✅ hit | 1 | 3/4 | Ch5, Ch5, Ch6, Ch5 |
...
| 13 | Follow-up questions like 'what about her?' return junk results — what technique addresses this? | Ch6 | ✅ hit | 1 | 2/4 | Ch6, Ch5, Ch4, Ch6 |
| 14 | What new risks appear when an assistant can read web pages or files that strangers can edit? | Ch5, Ch6 | ✅ hit | 1 | 4/4 | Ch5, Ch6, Ch5, Ch5 |
...
Hybrid leg: equal-weight RRF (k=60) over dense + hand-rolled BM25, 12
candidates/side. Net regression — purity 52/60 vs the control's 55/60:
Q3 gains one on-target chunk but Q7/Q9/Q10/Q13 each lose one, and Q8 (the
target failure) doesn't move because BM25 fails it identically to dense.
Full analysis in the [comparison artifact](2026-07-19-hybrid-comparison.md).
